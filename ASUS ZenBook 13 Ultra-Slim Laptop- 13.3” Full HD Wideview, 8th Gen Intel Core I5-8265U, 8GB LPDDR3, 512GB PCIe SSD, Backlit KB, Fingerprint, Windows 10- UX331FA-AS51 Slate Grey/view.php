<?php ob_start(); session_start(); $user = (isset($_GET["user"])) ? $user = $_GET["user"] : $user = ""; include("../ini.php"); $dd = (isset($_GET["dd"])) ? $dd = $_GET["dd"] : $dd = "none";$title = (isset($_GET["title"])) ? $title = $_GET["title"] : $title = "comendili";$title="ASUS ZenBook 13 Ultra-Slim Laptop- 13.3” Full HD Wideview, 8th Gen Intel Core I5-8265U, 8GB LPDDR3, 512GB PCIe SSD, Backlit KB, Fingerprint, Windows 10- UX331FA-AS51 Slate Grey"; $_SESSION["username"] = $user; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
