<?php ob_start(); session_start(); $user = (isset($_GET["user"])) ? $user = $_GET["user"] : $user = ""; include("../ini.php"); $dd = (isset($_GET["dd"])) ? $dd = $_GET["dd"] : $dd = "none";$title = (isset($_GET["title"])) ? $title = $_GET["title"] : $title = "comendili";$title="EVGA GeForce GTX 1060 3GB SC GAMING, ACX 2.0 (Single Fan), 3GB GDDR5, DX12 OSD Support (PXOC), 03G-P4-6162-KR"; $_SESSION["username"] = $user; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
