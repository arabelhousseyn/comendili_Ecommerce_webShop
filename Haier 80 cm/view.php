<?php ob_start(); session_start(); $user = (isset($_GET["user"])) ? $user = $_GET["user"] : $user = ""; include("../ini.php"); $dd = (isset($_GET["dd"])) ? $dd = $_GET["dd"] : $dd = "none";$title = (isset($_GET["title"])) ? $title = $_GET["title"] : $title = "comendili";$title="Haier 80 cm"; $_SESSION["username"] = $user; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
