<?php ob_start(); session_start(); $user = (isset($_GET["user"])) ? $user = $_GET["user"] : $user = ""; include("../ini.php"); $dd = (isset($_GET["dd"])) ? $dd = $_GET["dd"] : $dd = "none";$title = (isset($_GET["title"])) ? $title = $_GET["title"] : $title = "comendili";$title="test"; $_SESSION["username"] = $user; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto text-center mr-xl-5">
						...
						<li class="nav-item mr-lg-2 mb-lg-0 mb-2">
							<a class="nav-link" href="about.html"><?php echo lang('about'); ?></a>
						</li>
				...
				<div class="row footer-info w3-agileits-info">
					...
					<div class="col-md-3 col-sm-6 footer-grids mt-sm-0 mt-4">
						...
						<ul>
							...
							<li class="mb-3">
								<a href="help.html"><?php echo lang('help'); ?></a>
							</li>
							<li class="mb-3">
								<a href="faqs.html"><?php echo lang('fa'); ?></a>
							</li>
							<li class="mb-3">
								<a href="terms.html"><?php echo lang('term'); ?></a>
							</li>
							<li>
								<a href="privacy.html"><?php echo lang('priv'); ?></a>
							</li>
						</ul>
					</div>
